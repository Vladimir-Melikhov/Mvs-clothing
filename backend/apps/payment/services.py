...
class PaymentService:
    ...
    def create_checkout_session(order_id, user):
        ...
        try:
            ...
            logger.info(f"Created checkout session for order {order.order_number}: {checkout_session.id}")
    ...
    def handle_payment_intent_failed(payment_intent):
        ...
        try:
            ...
            logger.info(f"Payment failed for order {payment.order.order_number}: {error_message}")
