        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <div class="flex items-start">
            ...
            <div class="ml-3 text-xs">
              <label for="agree_privacy" class="text-gray-600">
                I agree to the <router-link to="/privacy" class="underline text-black">Privacy Policy</router-link> and consent to the processing of my data for demonstration purposes.
              </label>
            </div>
          </div>
          ...
          <div>
            <button
              ...
              class="submit-btn w-full flex justify-center py-3 px-4 border border-black text-sm font-medium tracking-widest text-black bg-white hover:bg-black hover:text-white focus:outline-none transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
