      ...
      <div class="max-w-7xl mx-auto">
        <div class="grid md:grid-cols-4 gap-12 mb-16">
          <div>
            ...
            <p class="mt-4 text-[10px] opacity-50 tracking-wider text-red-400 font-medium">
              DEMO PROJECT ONLY. NO REAL ORDERS.
            </p>
          </div>
        ...
        <div class="flex flex-col md:flex-row justify-between items-center text-xs opacity-60 tracking-wider font-light transition-colors duration-700" :style="{ color: footerCopyrightColor }">
          <p>© 2025 MVS. This site is for demonstration purposes only.</p>
          <div class="flex space-x-8 mt-4 md:mt-0">
            <router-link to="/privacy" class="hover:opacity-100 transition-opacity">Privacy Policy</router-link>
