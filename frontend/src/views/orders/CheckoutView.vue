      ...
      <div class="grid lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2">
          <form @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <div class="bg-yellow-50 border border-yellow-100 p-4 rounded">
              <div class="flex items-start">
                ...
                <div class="ml-3 text-sm">
                  <label for="agree_demo" class="text-gray-700">
                    I acknowledge that this is a <strong>demo site</strong>. No real products will be shipped, but the order process will be simulated. I agree to the <router-link to="/privacy" class="underline">Privacy Policy</router-link>.
                  </label>
                </div>
              </div>
            </div>
            ...
            <button
              type="submit"
              :disabled="submitting || cartStore.isEmpty || !agreedToTerms"
              class="w-full px-6 py-4 border border-black text-sm font-medium tracking-widest transition-all"
              :class="
                submitting || cartStore.isEmpty || !agreedToTerms
...
const handleSubmit = async () => {
  ...
  if (!agreedToTerms.value) {
    errorMessage.value = 'Please agree to the demo site terms'
    return
  }
